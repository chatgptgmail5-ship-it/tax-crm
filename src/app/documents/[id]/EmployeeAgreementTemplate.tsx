    ...
    <div className="space-y-4">
      ...
      >
        ...
        >
          ...
          {/* הנדון */}
          <p className="font-bold mb-1 text-center">הנדון: הסכם התקשרות למטרת הגשת דוח שנתי לשכירים</p>
          ...
          >
            <li>
              ...
              <ol className="list-decimal list-inside mr-4 mt-2 space-y-2">
                <li>
                  הנישום מייפה את כוחי למייצגו היחידי, לבצע עבורו את הטיפול בהגשת הדוחות למס
                  הכנסה לשכיר, לרבות פנייה לגורמים שונים לקבלת המסמכים הנדרשים לטיפול בעריכת
                  הדוח.
                </li>
                <li>
                  הנישום מתחייב בזאת כי מסר לי את כל הפרטים הנכונים והאמיתיים לצורך הגשת הדו&quot;ח
                  למס הכנסה בשקיפות מלאה.
                </li>
                <li>
                  הנישום מתחייב להגיש עזרה בכל נושא אשר יידרש לשם סיום ההליך, וכמו כן מודע
                ...
                <li>
                  ...
                  כתוצאה מהליך הבדיקה על ידי, קוזז לשם כיסוי החוב ברשויות לעיל יגבה שכ&quot;ט מלא
                  ללא קשר בתוצאת המס.
                </li>
                <li>
                  האחריות הראשונית לנכונות ושלמות הדוחות המוגשים למס הכנסה חלה על הנישום.
                </li>
              </ol>
            </li>
            <li>
              ...
              <ol className="list-decimal list-inside mr-4 mt-2 space-y-2">
                <li>
                  כמייצג הנני מתחייב לטפל בכל תהליך עריכה בפועל עבור השנים אשר הוגשו באמצעותי,
                  גם לאחר גביית שכ&quot;ט לרבות תיקון שומות, וייצוג במס הכנסה, בכפוף לאמור בסעיף 1.5
                  לעיל.
                </li>
                <li>
                  כמייצג הנני מתחייב כי כל הטיפול, התכתובת, במס הכנסה אשר נובעים כתוצאה מהליך
                  הגשת הדוח, יבוצעו על ידי ללא כל תוספת עמלה מעבר לעמלה המוסכמת בסעיף התמורה.
                </li>
                <li>
                  בכפוף לאמור בסעיף 1.5 לעיל כמייצג הנני מתחייב כי במידה והלקוח זכאי להחזר, ההחזר
                  יופקד לחשבון הבנק.
                </li>
                <li>
                  הנני מתחייב לפעול לפי כל דין ובפרט לפי חוק הסדרת העיסוק בייצוג על ידי יועצי מס.
                </li>
              </ol>
            </li>
            <li>
              ...
              <ol className="list-decimal list-inside mr-4 mt-2 space-y-2">
                <li>
                  תמורת הבדיקה, עריכה, והגשת הדוחות למס הכנסה באמצעותי, ישלם הנישום שכ&quot;ט בסך
                  של:{" "}
                  <strong style={{ textDecoration: "underline" }}>
                    1,500 ₪ בתוספת מע&quot;מ או 20% + מע&quot;מ מההחזר שיקבל הנישום לחשבון הבנק,
                    כגבוה מבניהם
                  </strong>
                  - שכ&quot;ט ישולם במועד החתימה על הדוחות.
                </li>
                <li>
                  <strong style={{ textDecoration: "underline" }}>
                    אי תשלום שכ&quot;ט במועד יגרור עיכוב בהגשת הדוחות ע&quot;י המייצג וזאת ללא כל זכות
                    של הלקוח לטענה ו/או תביעה כלשהיא כלפי המייצג.
                  </strong>
                </li>
                <li>
                ...
                <li>
                  במידה ויעביר הנישום את הטיפול בהגשת הדוחות למייצג אחר לאחר התחלת ההליך באמצעותי
                  ו/או יחליט כי אינו מעוניין בהמשך טיפול לאחר סיום הליך, ו/או ההגשה לרשויות, ישלם
                  הנישום למייצג סך 500 ₪ בתוספת מע&quot;מ כחוק.
                </li>
              </ol>
            </li>
          </ol>
